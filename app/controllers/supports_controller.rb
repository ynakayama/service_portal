...
class SupportsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @support.save
        format.html { redirect_to supports_path, notice: 'サポートメニューは正常に追加されました' }
  ...
  def update
    ...
    respond_to do |format|
      if @support.update_attributes(params[:support])
        format.html { redirect_to supports_path, notice: 'サポートメニューは正常に変更されました' }
